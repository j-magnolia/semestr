...
<!-- badges: start -->
[![Version: `r pkg$Version`](https://img.shields.io/github/r-package/v/j-magnolia/semestr?label=version)](`r str_c("https://github.com/j-magnolia", pkg$Package, "releases", "tag", str_c("v", pkg$Version), sep = "/")`)
